<?php  $scrpt_vrsn_dt  = 'fct_darksky_popup_hourly.php|00|2020-03-23|';  # release 2004
#-----------------------------------------------
...
echo '<span style="color: '.$color.'">'.$darkskyhourlySummary.'</span></div>
    </div>'.PHP_EOL;
...
';  // print start enclosing div table
#
...
<span style="float: right; font-size: 10px;"><a href="https://darksky.net/poweredby/" target="_blank" style="color: grey">
'.lang("Powered by").':&nbsp;&nbsp;
