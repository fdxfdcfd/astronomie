<?php $scrpt_vrsn_dt  = 'AQ_luftdaten_c_block.php|00|2020-03-23|';  # release 2004
#-----------------------------------------------
...
$pm25                   = false;                          # echo '<pre>'.print_r ($values,true);
...
#
$aqiweather['aqi']      = $aqi = number_format(pm25_to_aqi($pm25),1 ); 
...
'<div class="PWS_right" style="height: 110px;">
    <div class="PWS_div_right" style="height: 110px;  margin: 0px 5px; font-size: 10px; ">
        <span  class="normal" ><b>'.lang('Particle').'</b>:
        <br /><br />'.PHP_EOL;
#        
if (isset ($aqiweather['pm25']) ) 
     {  $right_text    .= '        <b>PM2.5<br />'.$aqiweather['pm25'].'</b><small> ug/m3</small><br />'.PHP_EOL;}
#  
if (isset ($aqiweather['pm10']) ) 
     {  $right_text    .= '        <b>PM10<br />' .$aqiweather['pm10'].'</b><small> ug/m3</small>'.PHP_EOL;}
$right_text    .= '        </span>
    </div>
</div>'.PHP_EOL;
